...
<main>
  <div className="main_index">
    ...
    <p>
      ...
      McBride. Copyrighted images are used for review purposes only.
      Meta information about this collection can be found below. A detailed list
  ...
  <div className ="funhome">
    <section>
      ...
      <p>
        Fun Home: A Family Tragicomic <br /> by Alison Bechdel <br /> 5 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>

{books.map(<div className = "watchmen">
    <section>
  ...
  <div className = "hunterhunter">
    <section>
      ...
      <p>
        Hunter X Hunter Vol. 1 <br /> by Yoshihiro Togashi <br /> 5 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
  ...
  <div className = "onepiece"> 
    <section>
      ...
      <p>
        One Piece, Vol. 1: Romance Dawn <br /> by Eiichiro Oda <br /> 5 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
  ...
  <div className = "wake">
    <section>
      ...
      <p>
        Wake: The Hidden History of Women-Led Slave Revolts <br /> by Rebecca Hall <br /> 4 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
  ...
  <div className = "blackpanther">
    <section>
      ...
      <p>
        Black Panther: A Nation Under Our Feet Book 1 <br /> by Ta-Nehisi Coates <br /> 3 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
  ...
  <div className = "thewalkingdead">
    <section>
      ...
      <p>
        The Walking Dead, Vol. 1: Days Gone Bye <br /> by Robert Kirkman <br /> 4 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
  ...
  <div className = "batman">
    <section>
      ...
      <p>
        Batman: The Dark Knight Returns <br /> by Frank Miller <br /> 3 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
  ...
  <div className = "queer">
    <section>
      ...
      <p>
        Queer: A Graphic History <br /> by Meg-John Baker <br /> 4 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
  ...
  <div className = "parable">
    <section>
      ...
      <p>
        Parable of the Sower <br /> by Octavia E. Butler <br /> 4 stars <br />
        <a href="#">Details</a>
      </p>
    </section>
  </div>
